...
- [Pinchflat](https://github.com/kieraneglin/pinchflat) - Pinchflat is an app for archiving content from internet video sites, including YouTube. It is built using yt-dlp.
